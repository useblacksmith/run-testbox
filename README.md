...
SSH connection reuse can outlive an individual command. A multiplexed master retained by OpenSSH `ControlPersist` still counts as a connected session; command exit alone does not establish that the runner is idle.
